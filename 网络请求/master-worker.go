...
//}
//
//func worker(group *sync.WaitGroup, tasks chan string,indexs chan int, result chan string) {
//	for task := range tasks {
//		if task == "" {
//			close(tasks)
//		} else {
//			respBody, err := NumberQueryRequest(task,indexs)
...
//}
//
//func NumberQueryRequest(ip_ string,index int) (body []byte, err error) {
